...
2. **Steps Execution**:
   ...
   - **Quality Gate Check**: Utilizes pinned stable `sonarsource/sonarqube-quality-gate-action@v1.2.0` to poll the server. If the Quality Gate fails, the workflow terminates, failing the build and blocking deployment.
