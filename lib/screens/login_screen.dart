    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0x1ACCFF00), // Equivalent to AppColors.accentNeonGreen.withOpacity(0.1)
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(color: const Color(0x4DCCFF00), width: 1.5), // Equivalent to withOpacity(0.3)
                ),
                child: const Icon(
          ...
          const SizedBox(height: 16),
          _buildStatusItem("Active Tournaments", "124 Live Now", Icons.emoji_events_outlined),
          const SizedBox(height: 12),
          _buildStatusItem("Ground Bookings Today", "3,481 Booked", Icons.stadium_outlined),
          const SizedBox(height: 12),
          _buildStatusItem("AI Scoring Engines", "Operational (99.8%)", Icons.psychology_outlined),
        ],
      ),
    );
  }
  ...
  Widget _buildLoginCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0x4D000000), // Equivalent to Colors.black.withOpacity(0.3)
            blurRadius: 30,
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? AppColors.accentNeonGreen : Colors.transparent,
                  borderRadius: BorderRadius.circular(8),
                  boxShadow: isSelected
                      ? [
                          BoxShadow(
                            color: const Color(0x4DCCFF00), // Equivalent to AppColors.accentNeonGreen.withOpacity(0.3)
                            blurRadius: 8,
  ...
  Widget _buildLoginButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0x40CCFF00), // Equivalent to AppColors.accentNeonGreen.withOpacity(0.25)
            blurRadius: 16,
